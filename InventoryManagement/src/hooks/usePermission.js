...
//   // Memoize the fetch function to prevent re-creations of the function on each render
...
//     // Store in both storages for quick access
//     const permsString = JSON.stringify(role.permissions || {});
//     sessionStorage.setItem('userPermissions', permsString);
//     localStorage.setItem('userPermissions', permsString);
...
//     const cachedPermissions = sessionStorage.getItem('userPermissions') || localStorage.getItem('userPermissions');
...
//   }, [fetchUserPermissions]); // Add fetchUserPermissions as a dependency

//   /**
//    * Check if user has permission for a specific module and action
//    * @param {string} module - Module name
//    * @param {string} action - Action type (create, edit, delete, view)
//    * @returns {boolean}
//    */
...
//    * @param {Array} checks - Array of {module, action} objects
//    * @returns {boolean}
//    */
